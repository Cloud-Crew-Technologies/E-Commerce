  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const response = await axios.get(
          `https://shisecommerce.skillhiveinnovations.com/api/batch/${batch}/products/${productId}`
        );
  ...
  const updateProductMutation = useMutation({
    mutationFn: async (data) => {
      ...
      const response = await axios.put(
        `https://shisecommerce.skillhiveinnovations.com/api/batch/${batch}/products/update/${productId}`,
