...
export default function EditProductDialog({ open, onOpenChange, productId }) {
  ...
  useEffect(() => {
    ...
    const fetchTypes = async () => {
      try {
        ...
        const response = await axios.get("https://texapi.skillhiveinnovations.com/api/types/get");
    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://texapi.skillhiveinnovations.com/api/products/get/${productId}`
        );
  ...
  const updateProductMutation = useMutation({
    mutationFn: async (data) => {
      ...
      const response = await axios.put(
        `https://texapi.skillhiveinnovations.com/api/${batchID}/products/update/${productId}`,
        formData,
        {
          headers: {
  ...
  const onSubmit = (data) => {
    ...
    axios.put(`https://texapi.skillhiveinnovations.com/api/products/update/${productId}`, data);
  };
